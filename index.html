...
<html lang="en">
  ...
  <body id="home">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark shadow fixed-top" style="background-color: #032a63">
      <div class="container">
        <a class="navbar-brand" href="#">HL Studio</a>
    ...
    <section class="jumbotron text-center">
      <img src="img/Label.jpeg" alt="Hilal Hibatullah" width="200" class="rounded-circle img-thumbnail shadow" />
      <h1 class="display-4">Hilal Hibatullah</h1>
      <p class="lead">UI/UX Design | Informatics Engineering</p>
    ...
    <section id="galeri">
      <div class="galeri">
        ...
        <div class="row justify-content-center">
          <div class="col-md-4">
            <div class="card">
              <img src="img/projects/1.jpeg" class="card-img-top" alt="projects 1" />
              <div class="card-body">
                <p class="card-text">Pemandangan ini mencerminkan kesan kedamaian dan keindahan di tengah-tengah kota yang sibuk.</p>
              </div>
            </div>
          </div>
          <div class="col-md-4">
            <div class="card">
              <img src="img/projects/2.jpeg" class="card-img-top" alt="projects 2" />
              <div class="card-body">
                <p class="card-text">Pemandangan sawah yang menakjubkan menghampar di depan mata. Luasnya ladang hijau yang subur membentang sejauh mata memandang, menciptakan kesan kedamaian dan keasrian.</p>
              </div>
            </div>
          </div>
          <div class="col-md-4">
            <div class="card">
              <img src="img/projects/3.jpeg" class="card-img-top" alt="projects 3" />
              <div class="card-body">
                <p class="card-text">Pemandangan pantai adalah tempat di mana alam memperlihatkan kemegahannya yang tak tergantikan, menawarkan kedamaian, keindahan, dan kesempatan untuk bersantai dan menghargai keajaiban bumi yang luar biasa.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row justify-content-center">
          <div class="col-md-6">
            <div class="mb-3">
              ...
              <input type="Text" class="form-control" id="Nama Lengkap" aria-describedby="name" />
            </div>
            <div class="mb-3">
            ...
            <button type="submit" class="btn btn-primary" style="background-color: #032a63; border: whiteB;">Kirim</button>
          </div>
        </div>
      </div>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
